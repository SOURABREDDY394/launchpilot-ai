...
import { useEffect, useRef } from "https://esm.sh/react@18.3.1?dev";
...
const Prism = ({
  ...
  useEffect(() => {
    ...
    const offX = _nullishCoalesce(_optionalChain([offset, 'optionalAccess', _ => _.x]), () => ( 0));
    const offY = _nullishCoalesce(_optionalChain([offset, 'optionalAccess', _2 => _2.y]), () => ( 0));
    ...
    glow,
    noise,
    _optionalChain([offset, 'optionalAccess', _3 => _3.x]),
    _optionalChain([offset, 'optionalAccess', _4 => _4.y]),
    scale,
    transparent,
    hueShift,
    colorFrequency,
  ...
  return React.createElement('div', { className: "prism-container", ref: containerRef,} );
};
